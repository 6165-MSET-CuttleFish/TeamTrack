        ...
        Column(
          children: [
            ...
            ScoreCard(
              ...
              scoreDivisions:
                  _team.scores.values.map((e) => e.autoScore).toList(),
              dice: _dice,
              removeOutliers: widget.event.statConfig.removeOutliers,
              matches: widget.event.getSortedMatches(true),
            ),
        ...
        Column(
          children: [
            ...
            ScoreCard(
              ...
              scoreDivisions:
                  _team.scores.values.map((e) => e.teleScore).toList(),
              dice: _dice,
              removeOutliers: widget.event.statConfig.removeOutliers,
              matches: widget.event.getSortedMatches(true),
            ),
        ...
        Column(
          children: [
            ...
            ScoreCard(
              ...
              scoreDivisions:
                  _team.scores.values.map((e) => e.endgameScore).toList(),
              dice: _dice,
              removeOutliers: widget.event.statConfig.removeOutliers,
              matches: widget.event.getSortedMatches(true),
            ),
  ...
  Widget _lineChart() => Collapsible(
        ...
        child: Column(
          ...
          children: [
            ...
            _team.scores.diceScores(_dice).length > 1
                ? Stack(
                                ...
                                : SfCartesianChart(
                                    ...
                                    series: <ChartSeries>[
                                      BoxAndWhiskerSeries<List<double>, int>(
                                        ...
                                        xValueMapper:
                                            (List<double> cycles, _) => _ + 1,
                                        yValueMapper:
                                            (List<double> cycles, _) =>
                                                cycles.length != 0
                                                    ? cycles
                                                    : [0, 0, 0, 0],
                                      ),
                                      ...
                                      if (_selections[2])
                                        LineSeries<int, int>(
                                          ...
                                          dataSource: _team.scores
                                              .diceScores(_dice)
                                              .map((e) =>
                                                  e.teleScore.teleCycles())
                                              .toList(),
                                          xValueMapper: (int misses, _) =>
                                              _ + 1,
                                          yValueMapper: (int misses, _) =>
                                              misses,
                                        ),
                                      if (_selections[3])
                                        LineSeries<int, int>(
